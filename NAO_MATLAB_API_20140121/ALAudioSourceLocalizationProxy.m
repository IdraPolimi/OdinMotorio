...
classdef ALAudioSourceLocalizationProxy < handle
    properties
    end
    ...
    methods
        function obj = ALAudioSourceLocalizationProxy(ip, port)
            obj.ptrProxyNaoQi = matlabproxy('ALAudioSourceLocalization',ip,port);
        end
