...
classdef ALMotionRecorderProxy < handle
    properties
    end
    ...
    methods
        function obj = ALMotionRecorderProxy(ip, port)
            obj.ptrProxyNaoQi = matlabproxy('ALMotionRecorder',ip,port);
        end
        ...
        function startInteractiveRecording(obj, varargin)
            matlabcall(obj.ptrProxyNaoQi, 'startInteractiveRecording', varargin);
        end
         
        function startPeriodicRecording(obj, varargin)
            matlabcall(obj.ptrProxyNaoQi, 'startPeriodicRecording', varargin);
        end
        ...
        function I = stopAndGetRecording(obj, varargin)
            I = matlabcall(obj.ptrProxyNaoQi, 'stopAndGetRecording', varargin);
        end
