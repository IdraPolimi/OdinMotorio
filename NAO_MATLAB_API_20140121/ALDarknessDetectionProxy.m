...
classdef ALDarknessDetectionProxy < handle
    properties
    end
    ...
    methods
        function obj = ALDarknessDetectionProxy(ip, port)
            obj.ptrProxyNaoQi = matlabproxy('ALDarknessDetection',ip,port);
        end
        ...
        function I = getDarknessThreshold(obj, varargin)
            I = matlabcall(obj.ptrProxyNaoQi, 'getDarknessThreshold', varargin);
        end
        ...
        function setDarknessThreshold(obj, varargin)
            matlabcall(obj.ptrProxyNaoQi, 'setDarknessThreshold', varargin);
        end
