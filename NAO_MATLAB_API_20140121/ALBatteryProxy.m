...
classdef ALBatteryProxy < handle
    properties
    end
    ...
    methods
        function obj = ALBatteryProxy(ip, port)
            obj.ptrProxyNaoQi = matlabproxy('ALBattery',ip,port);
        end
        ...
        function I = getBatteryCharge(obj, varargin)
            I = matlabcall(obj.ptrProxyNaoQi, 'getBatteryCharge', varargin);
        end
