...
classdef ALNavigationProxy < handle
    properties
    end
    ...
    methods
        function obj = ALNavigationProxy(ip, port)
            obj.ptrProxyNaoQi = matlabproxy('ALNavigation',ip,port);
        end
        ...
        function I = moveTo(obj, varargin)
            I = matlabcall(obj.ptrProxyNaoQi, 'moveTo', varargin);
        end
        ...
        function setSecurityDistance(obj, varargin)
            matlabcall(obj.ptrProxyNaoQi, 'setSecurityDistance', varargin);
        end
