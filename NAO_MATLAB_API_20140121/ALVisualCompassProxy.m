...
classdef ALVisualCompassProxy < handle
    properties
    end
    ...
    methods
        function obj = ALVisualCompassProxy(ip, port)
            obj.ptrProxyNaoQi = matlabproxy('ALVisualCompass',ip,port);
        end
        ...
        function enableReferenceRefresh(obj, varargin)
            matlabcall(obj.ptrProxyNaoQi, 'enableReferenceRefresh', varargin);
        end
        ...
        function I = getCurrentImage(obj, varargin)
            I = matlabcall(obj.ptrProxyNaoQi, 'getCurrentImage', varargin);
        end
        ...
        function I = getMatchingQuality(obj, varargin)
            I = matlabcall(obj.ptrProxyNaoQi, 'getMatchingQuality', varargin);
        end
        ...
        function I = getReferenceImage(obj, varargin)
            I = matlabcall(obj.ptrProxyNaoQi, 'getReferenceImage', varargin);
        end
         
        function I = getReferenceQuality(obj, varargin)
            I = matlabcall(obj.ptrProxyNaoQi, 'getReferenceQuality', varargin);
        end
        ...
        function I = setReferenceImage(obj, varargin)
            I = matlabcall(obj.ptrProxyNaoQi, 'setReferenceImage', varargin);
        end
