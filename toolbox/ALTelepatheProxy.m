...
classdef ALTelepatheProxy < handle
    properties
    end
    ...
    methods
        function obj=ALTelepatheProxy(ip, port)
            obj.ptrProxyNaoQi = matlabproxy('ALTelepathe',ip,port);
        end
        ...
        function clearLoginInformation(obj, varargin)
            matlabcall(obj.ptrProxyNaoQi, 'clearLoginInformation', varargin);
        end
        function connectNetwork(obj, varargin)
            matlabcall(obj.ptrProxyNaoQi, 'connectNetwork', varargin);
        end
        function disconnectNetwork(obj, varargin)
            matlabcall(obj.ptrProxyNaoQi, 'disconnectNetwork', varargin);
        end
        function enableRPC(obj, varargin)
            matlabcall(obj.ptrProxyNaoQi, 'enableRPC', varargin);
        end
        function eventCallback(obj, varargin)
            matlabcall(obj.ptrProxyNaoQi, 'eventCallback', varargin);
        end
        ...
        function I = isCalling(obj, varargin)
            I = matlabcall(obj.ptrProxyNaoQi, 'isCalling', varargin);
        end
        function I = isConnected(obj, varargin)
            I = matlabcall(obj.ptrProxyNaoQi, 'isConnected', varargin);
        end
        function I = isRPCEnabled(obj, varargin)
            I = matlabcall(obj.ptrProxyNaoQi, 'isRPCEnabled', varargin);
        end
        ...
        function sendMessage(obj, varargin)
            matlabcall(obj.ptrProxyNaoQi, 'sendMessage', varargin);
        end
        function I = sendRPC(obj, varargin)
            I = matlabcall(obj.ptrProxyNaoQi, 'sendRPC', varargin);
        end
        function setDebugMode(obj, varargin)
            matlabcall(obj.ptrProxyNaoQi, 'setDebugMode', varargin);
        end
        function setLoginInformation(obj, varargin)
            matlabcall(obj.ptrProxyNaoQi, 'setLoginInformation', varargin);
        end
        function startCall(obj, varargin)
            matlabcall(obj.ptrProxyNaoQi, 'startCall', varargin);
        end
        function stop(obj, varargin)
            matlabcall(obj.ptrProxyNaoQi, 'stop', varargin);
        end
        function stopCall(obj, varargin)
            matlabcall(obj.ptrProxyNaoQi, 'stopCall', varargin);
        end
