...
classdef ALSoundDetectionProxy < handle
    properties
    end
    ...
    methods
        function obj=ALSoundDetectionProxy(ip, port)
            obj.ptrProxyNaoQi = matlabproxy('ALSoundDetection',ip,port);
        end
        ...
        function I = getDescription(obj, varargin)
            I = matlabcall(obj.ptrProxyNaoQi, 'getDescription', varargin);
        end
        function I = getEvents(obj, varargin)
            I = matlabcall(obj.ptrProxyNaoQi, 'getEvents', varargin);
        end
