...
classdef ALLaserProxy < handle
    ...
    methods
        function obj=ALLaserProxy(ip, port)
            obj.ptrProxyNaoQi = matlabproxy('ALLaser',ip,port);
        end
        ...
        function laserOFF(obj, varargin)
            matlabcall(obj.ptrProxyNaoQi, 'laserOFF', varargin);
        end
        function laserON(obj, varargin)
            matlabcall(obj.ptrProxyNaoQi, 'laserON', varargin);
        end
        function I = ping(obj, varargin)
            I = matlabcall(obj.ptrProxyNaoQi, 'ping', varargin);
        end
        function setDetectingLength(obj, varargin)
            matlabcall(obj.ptrProxyNaoQi, 'setDetectingLength', varargin);
        end
        function setOpeningAngle(obj, varargin)
            matlabcall(obj.ptrProxyNaoQi, 'setOpeningAngle', varargin);
        end
