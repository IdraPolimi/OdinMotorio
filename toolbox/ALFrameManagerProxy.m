...
classdef ALFrameManagerProxy < handle
    ...
    methods
        ...
        function dataChanged(obj, varargin)
            matlabcall(obj.ptrProxyNaoQi, 'dataChanged', varargin);
        end
        ...
        function onPythonError(obj, varargin)
            matlabcall(obj.ptrProxyNaoQi, 'onPythonError', varargin);
        end
        function onPythonPrint(obj, varargin)
            matlabcall(obj.ptrProxyNaoQi, 'onPythonPrint', varargin);
        end
        function onRubyError(obj, varargin)
            matlabcall(obj.ptrProxyNaoQi, 'onRubyError', varargin);
        end
        function onRubyPrint(obj, varargin)
            matlabcall(obj.ptrProxyNaoQi, 'onRubyPrint', varargin);
        end
        function onUrbiError(obj, varargin)
            matlabcall(obj.ptrProxyNaoQi, 'onUrbiError', varargin);
        end
        function onUrbiPrint(obj, varargin)
            matlabcall(obj.ptrProxyNaoQi, 'onUrbiPrint', varargin);
        end
