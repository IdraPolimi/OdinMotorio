...
classdef ALSentinelProxy < handle
    ...
    methods
        ...
        function batteryChargeCellVoltageMinChanged(obj, varargin)
            matlabcall(obj.ptrProxyNaoQi, 'batteryChargeCellVoltageMinChanged', varargin);
        end
        ...
        function onAccX(obj, varargin)
            matlabcall(obj.ptrProxyNaoQi, 'onAccX', varargin);
        end
        function onAccY(obj, varargin)
            matlabcall(obj.ptrProxyNaoQi, 'onAccY', varargin);
        end
        function onAccZ(obj, varargin)
            matlabcall(obj.ptrProxyNaoQi, 'onAccZ', varargin);
        end
        ...
        function powerButtonOnPress(obj, varargin)
            matlabcall(obj.ptrProxyNaoQi, 'powerButtonOnPress', varargin);
        end
