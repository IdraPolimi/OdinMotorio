...
classdef ALRobotPoseProxy < handle
    properties
    end
    ...
    methods
        function obj=ALRobotPoseProxy(ip, port)
            obj.ptrProxyNaoQi = matlabproxy('ALRobotPose',ip,port);
        end
        ...
        function I = getActualPoseAndTime(obj, varargin)
            I = matlabcall(obj.ptrProxyNaoQi, 'getActualPoseAndTime', varargin);
        end
        ...
        function I = getPoseNames(obj, varargin)
            I = matlabcall(obj.ptrProxyNaoQi, 'getPoseNames', varargin);
        end
