...
classdef ALBonjourProxy < handle
    properties
    end
    ...
    methods
        function obj=ALBonjourProxy(ip, port)
            obj.ptrProxyNaoQi = matlabproxy('ALBonjour',ip,port);
        end
        ...
        function declare(obj, varargin)
            matlabcall(obj.ptrProxyNaoQi, 'declare', varargin);
        end
