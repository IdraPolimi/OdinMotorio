...
classdef ALAudioDeviceProxy < handle
    ...
    methods
        ...
        function sendAudioBuffer(obj, varargin)
            matlabcall(obj.ptrProxyNaoQi, 'sendAudioBuffer', varargin);
        end
        ...
        function setFileAsOutput(obj, varargin)
            matlabcall(obj.ptrProxyNaoQi, 'setFileAsOutput', varargin);
        end
        ...
        function I = subscribeLocalModule(obj, varargin)
            I = matlabcall(obj.ptrProxyNaoQi, 'subscribeLocalModule', varargin);
        end
        function I = subscribeRemoteModule(obj, varargin)
            I = matlabcall(obj.ptrProxyNaoQi, 'subscribeRemoteModule', varargin);
        end
        function I = unSubscribeLocalModule(obj, varargin)
            I = matlabcall(obj.ptrProxyNaoQi, 'unSubscribeLocalModule', varargin);
        end
